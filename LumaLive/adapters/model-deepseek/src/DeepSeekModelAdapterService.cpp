#include "IDeepSeekModelAdapterService.hpp"

namespace luma::adapters::model::deepseek {

class DeepSeekModelAdapterService final : public IDeepSeekModelAdapterService {
public:
